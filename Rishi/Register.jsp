...
Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3308/library","root","9490289121");

Statement st=con.createStatement();

if(s_pwd.equals(s_cpwd)){
	int s =st.executeUpdate("insert into student1 values('"+s_name+"','"+s_id+"','"+s_pwd+"','"+s_cpwd+"','"+s_dept+"','"+s_mail+"')");
